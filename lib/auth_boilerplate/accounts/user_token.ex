defmodule AuthBoilerplate.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, AuthBoilerplate.Accounts.User
  ...
  def build_session_token(user) do
    ...
    {token, %AuthBoilerplate.Accounts.UserToken{token: token, context: "session", user_id: user.id}}
  end
  ...
  defp build_hashed_token(user, context, sent_to) do
    ...
    %AuthBoilerplate.Accounts.UserToken{
      token: hashed_token,
      context: context,
      sent_to: sent_to,
      user_id: user.id
  ...
  def token_and_context_query(token, context) do
    from AuthBoilerplate.Accounts.UserToken, where: [token: ^token, context: ^context]
  end
