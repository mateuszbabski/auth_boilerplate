defmodule AuthBoilerplate.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, AuthBoilerplate.Repo)
  ...
  def valid_password?(%AuthBoilerplate.Accounts.User{hash_password: hash_password}, password)
